    ...
    return (
        <>
            <div className='container my-5'>
                ...
                <div className="my-2">
                    <div className="row">
                        <div className="my-2 pe-0 col-md-auto col-sm-12">
                        ...
                        <div className="my-2 p-md-0 col-md-auto col-sm-12">
                            <button type="button" className="btn btn-outline-dark ms-md-3 me-3" value="6" onClick={addOpera}>6</button>
